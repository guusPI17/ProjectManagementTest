...
#[Route('/api/platforms', name: 'platforms_list', methods: ['GET'])]
#[OA\Get(
    path: '/api/platforms',
    summary: 'Список платформ',
    tags: ['Platforms'],
    parameters: [
        new OA\Parameter(name: 'code', in: 'query', required: false, schema: new OA\Schema(type: 'string'), description: 'Фильтр по коду платформы'),
    ...
    responses: [
        new OA\Response(
            response: 200,
            description: 'Список платформ с пагинацией',
...
class ListPlatformsAction
{
    ...
    {
        $filter = new PlatformFilter($request);
